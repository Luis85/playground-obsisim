...
**OBS-4-09** is the one worth taking before increment 5 adds to it: it is the
one a player would actually notice — a hauler that turns round in open ground
before reaching the building it was sent to.
